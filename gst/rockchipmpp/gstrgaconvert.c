// Yanked from https://github.com/higithubhi/gstreamer-rgaconvert
/* GStreamer
...
{
    // TODO: do nothing if the src caps matches dest caps
    // TODO: maybe implement OSD?
    // TODO: rotate, mirror
    GstRgaConvert *rgaconvert = GST_RGA_CONVERT(filter);
...
{
    return gst_element_register(plugin, "rgaconvert", GST_RANK_PRIMARY,
